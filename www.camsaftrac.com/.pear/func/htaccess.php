...
if(!empty($_error) && in_array($_error,$_htaccess[0])){//Verification des parametres
 ...
 break; 
 case $_htaccess[0][1] :
  $replace='<h2>ERREUR 404 Not Found: le fichier démandé est introuvable</h2><p style="color:red;font-size:2em;font-weight:bold;text-align:left">ERREUR 404: Le fichier à l\'adressse <span style="color:lime;font-style:italic;">http://'.$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"].'</span> n\'existe pas ou n\'existe plus</p>'; 
 break; 
 case $_htaccess[0][2] :
