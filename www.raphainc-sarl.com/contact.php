...
X-Mailer: PHP/" . phpversion();   
 ...
 if(_loader('_db',$_param) && mail($to, $subject, $sms, $headers)){     
   $replace='</h2></caption><span style="color:green;font-size:1.2em;font-weight:bold;"> <marquee behavior="alternate" bgcolor="lime">MERCI POUR VOTRE MESSAGE</marquee>Nous vous remercions de l&apos;intérêt que vous porté à notre entreprise. Nous avons belle et bien pris acte de votre message et il sera traité dans les plus brefs délais pour une prompte réponse. Nous vous souhaitons un agréable surf sur notre site.</span></ br>';
   $html=str_replace($search,$replace,$html);
   echo($html);
  }
 else{
   $replace='</h2></caption><span style="color:#005000;font-size:1.2em;font-weight:bold;"> <marquee behavior="alternate" bgcolor="#E0FFD0"> DESOLE! ERREUR INTERNE </marquee>Une erreur interne s&apos;est produite lors de l&apos;envoi de votre message et nous ne l&apos;avons donc pas reçus. Vous en êtes aucunement responsable et nous vous prions de réessayer plustard. Si cela ne marche toujours pas, veuillez nous envoyer votre message par mail à l&apos;adresse <a href="raphainc@ymail.com" title="Contacts de RAPHA INC Sarl - exportation de bois et bambous depuis Douala au Cameroun" ><big>raphainc@ymail.com</big></a>.</span></ br>';
   $html=str_replace($search,$replace,$html);
   echo($html);
 }
 }
